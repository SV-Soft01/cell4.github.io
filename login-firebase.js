...
let users = [
  ...
  function addUser(e) {
    ...
    if (role === "admin") {
      ...
      if (logoFile) {
        convertImageToBase64(logoFile, (base64Image) => {
      ...
      const fullName = document.getElementById("cashier-fullname").value
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    // Cargar el script de Firebase para login
    const script = document.createElement('script');
    script.src = 'firebase-login.js';
    script.type = 'module';
